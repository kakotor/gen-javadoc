...
/**
 * Specific configuration class for getter javadoc.
 *
 * @author Burt Parkers
 */
public class GetterDocConfig extends AbstractDocConfig {

    /** The default template. */
    private static final String DEFAULT_TEMPLATE =
            "/**\n" +
            " * @return the value for the field $field.\n" +
            " */";

    /** The template value and configuration location. */
    @PropertyName(value = "gendoc.getter.template")
